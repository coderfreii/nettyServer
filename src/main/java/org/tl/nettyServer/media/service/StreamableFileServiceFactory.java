 ...
 * 创建可流式文件服务
 */
public class StreamableFileServiceFactory implements IStreamableFileServiceFactory {

    // Initialize Logging
    public static Logger logger = LoggerFactory.getLogger(StreamableFileServiceFactory.class);
    ...
    public void setServices(Set<IStreamableFileService> services) {
        logger.debug("StreamableFileServiceFactory set services");
    ...
    public Set<IStreamableFileService> getServices() {
        logger.debug("StreamableFileServiceFactory get services");
        return services;
    }
}
