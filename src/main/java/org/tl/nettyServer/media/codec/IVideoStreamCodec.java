...
public interface IVideoStreamCodec {
    ...
    public final static class FrameData {
        ...
        public FrameData(BufFacade data) {
            setData(data);
        }

        /**
         * Makes a copy of the incoming bytes and places them in an BufFacade. No flip or rewind is performed on the source data.
         *
         * @param data data
         */
        ...
        public BufFacade getFrame() {
            return frame == null ? null : BufFacade.wrappedBuffer(frame);
        }
