...
package org.tl.nettyServer.media.media.flv;
...
public class FLVHeader {
     ...
     * FLV version
     */
    public static byte version = 0x01 & 0xff; //version 1
    ...
    public void write(BufFacade buffer) {
        ...
        // flags
        buffer.writeByte((byte) (FLV_HEADER_FLAG_HAS_AUDIO * (flagAudio ? 1 : 0) + FLV_HEADER_FLAG_HAS_VIDEO * (flagVideo ? 1 : 0)));
        // data offset
        buffer.writeInt(9);
