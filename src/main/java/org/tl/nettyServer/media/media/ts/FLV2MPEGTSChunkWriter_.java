 ...
 * @author pengliren
 */
public class FLV2MPEGTSChunkWriter_ implements IFLV2MPEGTSWriter {
    ...
    public FLV2MPEGTSChunkWriter_(BufFacade videoConfig, BufFacade audioConfig, boolean isEncrypt) {
