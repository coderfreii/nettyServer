...
import org.tl.nettyServer.media.stream.support.DynamicPlayItem;
import org.tl.nettyServer.media.stream.support.SimplePlayItem;
...
public class StreamService {
    ...
    public static void sendNetStreamStatus(IConnection conn, String statusCode, String description, String name, String status, Number streamId) {
        if (conn instanceof RTMPConnection) {
            ...
            Channel channel = rtmpConn.createChannelIfAbsent(rtmpConn.getChannelIdForStreamId(streamId));
