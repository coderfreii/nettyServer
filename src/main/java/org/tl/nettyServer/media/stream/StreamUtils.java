...
import org.tl.nettyServer.media.stream.server.ServerPlaylistBroadcastStream;
...
public abstract class StreamUtils {
    ...
    private static volatile ConcurrentMap<String, IServerPlaylistBroadcastStream> serverStreamMap = new ConcurrentHashMap<String, IServerPlaylistBroadcastStream>(16, 0.75f, 4);
     ...
     * @param name
     *            Name of stream
     * @return IServerPlaylistBroadcastStream object
     */
    public static IServerPlaylistBroadcastStream createServerStream(IScope scope, String name) {
        logger.debug("Creating server stream: {} scope: {}", name, scope);
        ServerPlaylistBroadcastStream stream = new ServerPlaylistBroadcastStream();
     ...
     * @return IServerPlaylistBroadcastStream object
     */
    public static IServerPlaylistBroadcastStream getServerStream(IScope scope, String name) {
     ...
     *            Name of stream
     * @param stream
     *            ServerPlaylistBroadcastStream object
     */
    public static void putServerStream(IScope scope, String name, IServerPlaylistBroadcastStream stream) {
