...
//	}
	 ...
	 * @param paramInt1   start of byte index
	 * @param paramInt2	  count of byte after paramInt1 index( include start index)
	 * @return
	 */
	...
	public static int byteArrayToInt(byte[] paramArrayOfByte, int paramInt1,
		...
		for (int j = 0; j < paramInt2; j++) {
			...
			if (paramBoolean)
				...
				i |= paramArrayOfByte[(paramInt1 + j)] & 0xFF;   //依次一个byte并与上一个byte拼接
		}
		return i;
	}
