package org.tl.nettyServer.media.io.ts.codec;
...
import org.tl.nettyServer.media.io.ts.TSPacketFragment;
            ...
            if ((this.videoCodec == VideoCodec.AVC.getId()) && (AVCPacketType != 1)) {
                if (AVCPacketType == 0) {
                    ...
                    if (this.h264CodecConfigPart == null) {
                        this.h264CodecConfigPart = NettyH264Utils.breakApartAVCC(dataBuff);
