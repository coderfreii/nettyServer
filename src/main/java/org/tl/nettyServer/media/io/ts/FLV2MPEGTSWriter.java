...
import org.tl.nettyServer.media.io.mp3.MP3BufferedDecoder;
import org.tl.nettyServer.media.io.mp3.MP3HeaderData;
import org.tl.nettyServer.media.io.ts.codec.VideNaluInfosResolver;
...
import static org.tl.nettyServer.media.io.ts.TransportStreamUtils.*;
...
public class FLV2MPEGTSWriter {
    ...
    protected NettyAACFrame aacFrame = null;
    ...
    public FLV2MPEGTSWriter(IFLV2MPEGTSWriter writer, BufFacade videoConfig, BufFacade audioConfig) {
        ...
        if (videoConfig != null) {
            ...
            if (videoCodec == VideoCodec.AVC.getId()) {
                ...
                h264CodecConfigPart = NettyH264Utils.breakApartAVCC(videoConfig);
            }
        }
        ...
        if (audioConfig != null) {
            ...
            if (audioCodec == AudioCodec.AAC.getId()) {
                ...
                aacFrame = NettyAACUtils.decodeAACCodecConfig(audioConfig);
            }
        }
    }
    ...
    public void handleAudio(AudioData data) {
        ...
        if (codecId == AudioCodec.AAC.getId() && AACPacketType == 0) {
            NettyAACFrame tempFrame = NettyAACUtils.decodeAACCodecConfig(dataBuff);
            ...
            if (codecId == AudioCodec.AAC.getId()) {
                ...
                NettyAACUtils.frameToADTSBuffer(aacFrame, adts, 0);
