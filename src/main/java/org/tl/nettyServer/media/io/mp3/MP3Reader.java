...
public class MP3Reader implements ITagReader, IKeyFrameDataAnalyzer {
    ...
    private ITag createFileMeta() {
        ...
        BufFacade in = BufFacade.buffer(1024);
        ...
        out.writeMap(props);
        // meta-data
        ITag result = new Tag(IoConstants.TYPE_METADATA, 0, in.readableBytes(), null, prevSize);
        result.setBody(in);
        return result;
    }
    ...
    public ITag readTag() {
        ...
        try {
            ...
            BufFacade body = BufFacade.buffer(tag.getBodySize());
