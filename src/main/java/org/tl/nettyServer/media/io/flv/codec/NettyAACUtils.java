...
public class NettyAACUtils {
    ...
    public static NettyAACFrame decodeFrame(BufFacade data) {

        if (data.readableBytes() < 7) return null;
        NettyAACFrame aacFrame = null;
    ...
    public static NettyAACFrame decodeAACCodecConfig(BufFacade buffer) {
    ...
    public static BufFacade frameToADTSBuffer(NettyAACFrame aacFrame) {
     ...
     * @param startIdx
     */
    public static void frameToADTSBuffer(NettyAACFrame aacFrame, byte[] adts, int startIdx) {
