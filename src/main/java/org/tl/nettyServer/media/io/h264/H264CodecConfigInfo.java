...
public class H264CodecConfigInfo {
	...
	public String toString() {
		...
		sb.append("profile: ").append(NettyH264Utils.profileIDCToString(this.profileIDC)).append(", ");
		sb.append("level: ").append(NettyH264Utils.levelIDCToString(this.levelIDC)).append(", ");
