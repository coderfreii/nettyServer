...
package org.tl.nettyServer.media.client;
...
import org.tl.nettyServer.media.stream.bandwidth.ClientServerDetection;
import org.tl.nettyServer.media.stream.bandwidth.ServerClientDetection;
...
public class Client extends AttributeStore implements IClient {
     ...
     *            Connection object
     */
    public void register(IConnection conn) {
        if (log.isDebugEnabled()) {
            if (conn == null) {
     ...
     */
    public void unregister(IConnection conn) {
     ...
     * Removes client-connection association for given connection 
     */
    public void unregister(IConnection conn, boolean deleteIfNoConns) {
