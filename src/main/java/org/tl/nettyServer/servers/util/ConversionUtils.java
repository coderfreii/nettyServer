...
package org.tl.nettyServer.servers.util;
...
public class ConversionUtils {
    ...
    /**
     * Mapping from wrapperAndCast class to appropriate parameter types (in order) Each entry is an array of Classes, the last of which is either null (for no chaining) or the next class to try
     */
    ...
    /**
     * Convert string to primitive wrapperAndCast like Boolean or Float
     * 
     * @param str
     *            String to convert
     * @param wrapper
    ...
    public static Object convertStringToWrapper(String str, Class<?> wrapper) {
        log.trace("String: {} to wrapperAndCast: {}", str, wrapper);
    ...
    /**
     * Convert number to primitive wrapperAndCast like Boolean or Float
     * 
     * @param num
     *            Number to conver
     * @param wrapper
