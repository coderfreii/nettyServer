...
package org.tl.nettyServer.servers.net.rtmp.task;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.springframework.core.task.TaskRejectedException;
import org.springframework.scheduling.concurrent.ThreadPoolTaskScheduler;
import org.tl.nettyServer.servers.Red5;
import org.tl.nettyServer.servers.net.rtmp.handler.packet.IRtmpPacketHandler;
...
public final class ReceivedMessageTask implements Callable<Packet> {
    ...
    private final IRtmpPacketHandler handler;
    ...
    public ReceivedMessageTask(String sessionId, Packet packet, IRtmpPacketHandler handler, SessionFacade conn) {
    ...
    public Packet call() throws Exception {
        ...
        // 将连接设置为线程本地
        //TODO
        Red5.setConnectionLocal(session.getConnection());
        try {
            //将消息传递给处理程序
    ...
    public void runDeadlockFuture(Runnable deadlockGuardTask) {
        if (deadlockFuture == null) {
            ThreadPoolTaskScheduler deadlockGuard = session.getDeadlockGuardScheduler();
