...
package org.tl.nettyServer.servers.net.rtmp;
...
import org.tl.nettyServer.servers.net.rtmp.event.Invoke;
import org.tl.nettyServer.servers.net.rtmp.event.Notify;
        ...
        if (connection != null) {
            ...
            if (andReturn) {
                ...
                if (status.getCode().equals(StatusCodes.NS_PLAY_START)) {
                    boolean videoAccess = true;
                    boolean audioAccess = true;
