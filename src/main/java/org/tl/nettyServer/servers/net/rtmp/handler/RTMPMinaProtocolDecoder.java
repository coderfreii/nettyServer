 ...
 */
@Slf4j
public class RTMPMinaProtocolDecoder extends MessageToMessageDecoder<BufFacade<ByteBuf>> {
...
//     * {@inheritDoc}
//     */
//    public void decode(IoSession session, BufFacade in, ProtocolDecoderOutput out) throws ProtocolCodecException {
...
//            // 在session中存储buffer
//            BufFacade buf = (BufFacade) session.getAttribute("buffer");
//            if (buf == null) {
//                buf = BufFacade.allocate(arr.length);
