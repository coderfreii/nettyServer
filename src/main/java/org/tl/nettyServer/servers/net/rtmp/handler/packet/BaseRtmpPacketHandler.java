...
import org.tl.nettyServer.servers.ICommand;
import org.tl.nettyServer.servers.event.IEventDispatcher;
import org.tl.nettyServer.servers.net.rtmp.Channel;
import org.tl.nettyServer.servers.net.rtmp.codec.RTMP;
import org.tl.nettyServer.servers.net.rtmp.conn.IConnection;
import org.tl.nettyServer.servers.net.rtmp.conn.IConnectionManager;
...
import org.tl.nettyServer.servers.service.IPendingServiceCall;
import org.tl.nettyServer.servers.service.IPendingServiceCallback;
import org.tl.nettyServer.servers.service.IServiceCall;
import org.tl.nettyServer.servers.so.SharedObjectMessage;
import org.tl.nettyServer.servers.stream.IClientStream;
...
public abstract class BaseRtmpPacketHandler implements IRtmpPacketHandler, Constants, StatusCodes {
    ...
    @Override
    public void messageReceived(SessionFacade sessionFacade, Packet packet) throws Exception {
    	if (sessionFacade == null) {
        	return;
        }
    	log.trace("messageReceived connection: {}", sessionFacade.getSessionId());
        IRTMPEvent message = null;
        IConnection conn = sessionFacade.getConnection();
        try {
