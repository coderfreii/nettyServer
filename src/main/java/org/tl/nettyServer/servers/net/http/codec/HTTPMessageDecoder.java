...
import org.tl.nettyServer.servers.net.http.message.*;
import org.tl.nettyServer.servers.net.http.response.HTTPResponse;

import java.util.List;
import java.util.concurrent.atomic.AtomicBoolean;

import static org.tl.nettyServer.servers.net.http.message.HTTPHeaders.Names.CONTENT_TYPE;
...
public abstract class HTTPMessageDecoder extends ByteToMessageDecoder {
        ...
        switch (state) {
            ...
            case READ_HEADER: {
                ...
                if (nextState == State.READ_CHUNK_SIZE) {
                    ...
                    chunkMessage.setHttpMessage(message);
                    decodeState.setObject(chunkMessage);
                    return decodeState;
                ...
                // We return null here, this forces decodes to be called again where we will decodes the content
                return decodeState;
            }
            case READ_VARIABLE_LENGTH_CONTENT: {
                if (content == null) {
    ...
    /**
     * each line of http protocol as small part of message ,so we often read each line to decodes buff
     * <p>
     * 读后重置指针
     *
     * @param buffer
