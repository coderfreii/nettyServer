...
import org.tl.nettyServer.servers.io.amf.Input;
import org.tl.nettyServer.servers.io.object.DataTypes;
import org.tl.nettyServer.servers.io.object.Deserializer;
import org.tl.nettyServer.servers.io.object.IInput;
import org.tl.nettyServer.servers.util.ArrayUtils;
import org.tl.nettyServer.servers.util.ConversionUtils;
 ...
 */
public class Input3 extends Input implements IInput {
     ...
     */
    public Input3(BufFacade buf, RefStorage refStorage) {
        super(buf);
    ...
    public String readString() {
        ...
        if (currentDataType == AMF3.TYPE_STRING || amf3_mode > 0) {
            ...
            buf.capacity(limit); // reset the limit
    ...
    public Object readObject() {
        ...
        if ((type & 1) == 0) {
            ...
            if (b == 7) {
                ...
                log.debug("Non-BEL byte: {} extra byte: {}", b, buf.readByte());
            }
        }
        type >>= 1;
    ...
    public Vector<Long> readVectorUInt() {
        ...
        int ref2 = readInteger();
        for (int j = 0; j < len; ++j) {
            long value = (buf.readByte() & 0xff) << 24L;
            value += (buf.readByte() & 0xff) << 16L;
            value += (buf.readByte() & 0xff) << 8L;
