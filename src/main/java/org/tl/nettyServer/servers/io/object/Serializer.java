...
package org.tl.nettyServer.servers.io.object;

import org.apache.commons.beanutils.BeanMap;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.tl.nettyServer.servers.annotations.DontSerialize;
import org.tl.nettyServer.servers.annotations.RemoteClass;
import org.tl.nettyServer.servers.io.amf.Output;
import org.tl.nettyServer.servers.io.amf3.ByteArray;
import org.tl.nettyServer.servers.io.amf3.IExternalizable;
import org.tl.nettyServer.servers.io.amf3.Output3;
...
public class Serializer {
     ...
     */
    public static void serialize(IOutput out, Object any) {
    ...
    public static void serialize(IOutput out, Field field, Method getter, Object object, Object value) {
        log.trace("serialize");
    ...
    protected static boolean writeBasic(IOutput out, Object basic) {
        if (basic == null) {
            out.writeNull();
     ...
     * @return boolean true if object was successfully serialized, false otherwise
     */
    public static boolean writeComplex(IOutput out, Object complex) {
     ...
     * @return boolean true if object was successfully serialized, false otherwise
     */
    protected static boolean writeListType(IOutput out, Object listType) {
     ...
     */
    protected static void writeList(IOutput out, List<?> list) {
        if (!list.isEmpty()) {
            int size = list.size();
    ...
    protected static boolean writeArrayType(IOutput out, Object arrType) {
     ...
     */
    protected static void writeIterator(IOutput out, Iterator<Object> it) {
     ...
     */
    protected static boolean writeXMLType(IOutput out, Object xml) {
     ...
     */
    protected static void writeDocument(IOutput out, Document doc) {
        out.writeXML(doc);
    }
     ...
     */
    @SuppressWarnings("all")
    protected static boolean writeObjectType(IOutput out, Object obj) {
     ...
     * @return <tt>true</tt> if the object has been written, otherwise <tt>false</tt>
     */
    protected static boolean writeCustomType(IOutput out, Object obj) {
        if (out.isCustom(obj)) {
            // Write custom data
            out.writeCustom(obj);
            return true;
