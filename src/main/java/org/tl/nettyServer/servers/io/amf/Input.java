...
public class Input extends BaseInput implements IInput {
    ...
    public Boolean readBoolean() {
        return (buf.readByte() == AMF.VALUE_TRUE) ? Boolean.TRUE : Boolean.FALSE;
    }
    ...
    public Date readDate() {
        ...
        short timeZoneMins = buf.readShort();
    ...
    public Object readReference() {
        return getReference(buf.readUnsignedShort());
    }
